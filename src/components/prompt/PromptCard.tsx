...
export function PromptCard({ entry, isSelected, onClick }: PromptCardProps) {
  ...
  return (
    <article
      ...
      className={`group cursor-pointer rounded-[16px] border bg-surface-card flex flex-col overflow-hidden transition-all duration-200 hover:-translate-y-0.5 hover:shadow-card-hover ${
