...
function PropRow({
  ...
  return (
    <div className="grid grid-cols-[80px_1fr] sm:grid-cols-[130px_1fr] items-start gap-xs">
      ...
      <div className="sticky top-0 z-20 h-0 overflow-visible">
        <div className="flex items-center justify-end px-md pt-xs">
          <button
            onClick={onClose}
            aria-label="패널 닫기"
            className="w-8 h-8 flex items-center justify-center rounded-full bg-canvas/70 backdrop-blur-sm border border-subtle/40 text-on-dark hover:bg-canvas/85 hover:text-on-dark transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
          >
            <X size={16} />
          </button>
        </div>
